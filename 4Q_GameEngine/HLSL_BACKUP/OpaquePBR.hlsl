...
float4 main(PS_INPUT input) : SV_TARGET
{
    ...
    float3 ViewVector = normalize(CameraPosition - input.PosWorld);
    ...
    float3 final = DirectionLighting + AmbientLighting + PointLighting; //    +EmissiveLighting; //saturate(directionLighting + BaseColor);
