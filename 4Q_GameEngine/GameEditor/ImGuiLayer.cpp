...
//	ImGui_ImplWin32_Init(GameApp::m_pInstance->m_hWnd);
//	ImGui_ImplDX11_Init(D3DRenderer::GetInstance()->m_pDevice.Get(), D3DRenderer::GetInstance()->m_pDeviceContext.Get());
//}
//
...
//	io.DisplaySize = ImVec2(app.m_ClientWidth, app.m_ClientHeight);
//
//	ImGui::Render();
