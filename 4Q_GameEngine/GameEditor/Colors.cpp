...
#include "Colors.h"
#include <cmath>
float Colors::Convert_sRGB_FromLinear(float theLinearValue)
{
...
float Colors::Convert_sRGB_ToLinear(float thesRGBValue)
{
...
ImVec4 Colors::ConvertFromSRGB(ImVec4 colour)
{
...
ImVec4 Colors::ConvertToSRGB(ImVec4 colour)
{
